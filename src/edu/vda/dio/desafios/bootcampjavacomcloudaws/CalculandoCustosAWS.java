...
public class CalculandoCustosAWS {
    public static void main(String[] args) {
        ...
        double custoPorHoraDoServidor = 0.15;
        double custoPorHoraDoBancoDeDados = 0.05;

        double custoTotal = (custoPorHoraDoServidor * quantidadeServidores) + (custoPorHoraDoBancoDeDados * quantidadeBancosDados);
